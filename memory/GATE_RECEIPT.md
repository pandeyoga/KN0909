...
- **Waktu:** 2026-09-02 13:57:43
- **Mode:** `default`  ·  **Durasi total:** 206s  ·  **Pekerja statik:** 2
...
| audit_sales_roles_ux (SEMUA peran: nol layar & panel mati) | PASS (42s) |
...
| POC FASE S (sampling: dua jenis paralel · ukur dari master · jadi→kirim · nol residu) | FAIL (3s) |
